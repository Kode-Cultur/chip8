...
impl Chip8 {
    ...
    fn read_opcode(&self) -> u16 {
        (self.mem[self.i as usize] as u16) << 8 | (self.mem[(self.i + 1) as usize] as u16)
    }
    ...
    fn process_opcode(&mut self, opcode: u16) {
        ...
        match (op_0, op_1, op_2, op_3) {
            (0, 0, 0xE, 0) => self.display.clear(), // Clear display.
            ...
            (0x9, _, _, _) => {
                self.pc += if self.v[x] != self.v[0xF] { 2 } else { 0 }
            },
            ...
            (0xF, _, 0x2, 0x9) => { self.i = self.v[x] as u16 },
